...
<head>
  ...
  <link rel="icon" href="data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%20100%20100%22%3E%3Crect%20width%3D%22100%22%20height%3D%22100%22%20rx%3D%2220%22%20fill%3D%22%234F46E5%22%2F%3E%3Ctext%20x%3D%2250%22%20y%3D%2266%22%20font-family%3D%22sans-serif%22%20font-size%3D%2256%22%20font-weight%3D%22700%22%20text-anchor%3D%22middle%22%20fill%3D%22%23ffffff%22%3EV%3C%2Ftext%3E%3C%2Fsvg%3E" />
  <link rel="stylesheet" href="${esc(sharedHref)}elevate-lite/tokens/elevate.css?v=${esc(cacheBust)}" />
  <link rel="stylesheet" href="${esc(sharedHref)}elevate-lite/components/elevate.css?v=${esc(cacheBust)}" />
  <link rel="stylesheet" href="${esc(sharedHref)}elevate-lite/icons/icons.css?v=${esc(cacheBust)}" />
  <style>
    body { margin: 0; }
